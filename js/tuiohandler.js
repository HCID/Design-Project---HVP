...
var client, currentHands, fingers, node_drag, onAddTuioCursor, onRefresh, onRemoveTuioCursor, onRemoveTuioHand, onUpdateTuioCursor, onUpdateTuioHand, once, showMenu, windowHeight, windowWidth;
...
node_drag = d3.behavior.drag().on("dragstart", function(d) {}).on("drag", function(d, i) {
  d.px += d3.event.dx;
  d.py += d3.event.dy;
  d.x += d3.event.dx;
...
/*
//@ sourceMappingURL=tuiohandler.map
*/
